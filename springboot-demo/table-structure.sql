...
CREATE TABLE `sys_log` (
  ...
  `action` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '0:DB查询、1:DB新增、2:DB删除、3:DB修改',
...
CREATE TABLE `sys_menu` (
  ...
  `menu_level` tinyint unsigned NOT NULL COMMENT '菜单级别，0:一级，1:二级，2:三级，3:四级',
  `menu_order` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '菜单排序',
...
CREATE TABLE `sys_role` (
  ...
  `parent_id` int DEFAULT NULL COMMENT '上级角色id',
  `role_level` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '角色级别：1-一级，2-二级...',
...
CREATE TABLE `sys_role_menu` (
  ...
  `check_state` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '选中状态：0未选中,1选中,2半选',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE `sys_user` (
  ...
  `sex` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '用户性别，0：男，1：女',
  `mobile` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '手机号码',
  `status` int unsigned NOT NULL DEFAULT '0' COMMENT '状态  0：正常   1：禁用',
